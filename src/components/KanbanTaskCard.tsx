        ...
        <div className="flex flex-col items-start justify-end pt-1">
          {taskEndDate && (
            <div className={cn(
              ...
              <span className="line-clamp-1">{format(taskEndDate, 'PPP', { locale: currentLocale })}</span>
              {isOverdue && (
          ...
          {domainTitle && (
            <Badge variant="outline" className="mt-1 font-normal text-[0.6rem] px-1 py-0.5 line-clamp-1">
              {domainTitle}
            </Badge>
          )}
        </div>
