    ...
    <div className="mt-8">
      ...
      <div className="mt-6">
        <h2 className="text-lg font-semibold mb-4">
          {t('calendar.selectedDayTasks', { date: date ? format(date, 'PPP', { locale: currentLocale }) : '' })}
        </h2>
                ...
                >
                  <CardContent className="p-3 flex items-start gap-3">
                    ...
                    <div className="flex-1 border-l pl-3">
                      <p className={cn("font-medium line-clamp-2", isDone && "line-through text-muted-foreground")}> {/* Ajout de line-clamp-2 */}
                        {task.content}
                      </p>
